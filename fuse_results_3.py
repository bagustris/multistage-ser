...
def main():
    predictions = ['my_predictions2/predictions_b',
                   'my_predictions2/predictions_c',
                   'my_predictions2/predictions_d',
                   'my_predictions2/predictions_e',
                   'my_predictions2/predictions_l',
                   'my_predictions2/predictions_m',
                   'my_predictions2/predictions_p',
                   'my_predictions2/predictions_q',
                   'my_predictions2/predictions_s',
                   'my_predictions2/predictions_2',
                   'my_predictions2/predictions_9',
                   'my_predictions2/predictions_10', #,
                   'CES_AIS_2b'] #,
                   #'CES_ais_1f',
                   #'CES_ais_1g',
                   #'CES_ais_1h'] #,
                   #'my_predictions/predictions_k'] #,
                   #'my_predictions/predictions_visual-resnet',
                   #'my_predictions/predictions_visual-vgg']
    num_steps = 1768
    ...
    for context in contexts:
        ...
        for complexity in complexities:  
            svr_models = []
            for dim in range(len(dimensions)):
                svr_models.append( LinearSVR(C=complexity, random_state=0, max_iter=3000).fit(pred_models_context.reshape(pred_models_context.shape[0],-1), gold[:,dim]) )  # Use all dimensions to train the model for each dimension
    ...
    for dim in range(len(dimensions)):
        ...
        svr_models.append( LinearSVR(C=complexity_opt[dim], random_state=0, max_iter=3000).fit(pred_models_context.reshape(pred_models_context.shape[0],-1), gold[:,dim]) )  # Use all dimensions to train the model for each dimension    
